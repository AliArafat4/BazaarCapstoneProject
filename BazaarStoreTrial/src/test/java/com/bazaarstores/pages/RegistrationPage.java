...
public class RegistrationPage extends BasePage {
    ...
    public void validateSuccessMessage() {
        ...
        if (currentUrl.contains("post-sign-up")) {
            Assert.fail("Registration failed: user redirected to 500 error page!");
        }

        else if (currentUrl.contains("dashboard") || currentUrl.contains("home")) {
            System.out.println("Registration successful and redirected to the correct page!");
        }}
    ...
    public RegistrationPage enterPasswordConfirmation(String confirmPassword){
        Driver.getDriver().findElement(this.passwordConfirmation).sendKeys(confirmPassword);
        return this;
    }
    ...
    public RegistrationPage validateInvalidEmail(){
        ...
        assertEquals(
                "The email field must be a valid email address.", Driver.getDriver().findElement(invalidEmailMessage).getText()
        );
